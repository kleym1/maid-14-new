...
book-text-escalation-security =
    ...
    Твоим следующим шагом будет использование не летальных или более-менее летальных устройств, такие как дубинки-шокеры, дизейблеры, флешки и светошумовые. Просто убедись что ты прошёл обучение, прежде чем использовать их. Предлагать их подозреваемому взамен на его сотрудничество не лучшее использование этих инструментов.
